...
export default function ConfirmDialog({ title = "ARE YOU SURE?", message, confirmLabel = "YES, DO IT", variant = "danger", onConfirm, onCancel }) {
  return (
    <Modal title={title} onClose={onCancel}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <PixelButton variant={variant} onClick={onConfirm}>
          {confirmLabel}
        </PixelButton>
      </div>
    </Modal>
